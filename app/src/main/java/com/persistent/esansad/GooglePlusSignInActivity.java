...
public class GooglePlusSignInActivity extends Activity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUserSignUp = (Button) findViewById(R.id.btnUserSignIn);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnUserSignIn:
                userLoginOrSignUp();
                break;
        }
    }

    private void userLoginOrSignUp() {
        try {
            APIHelper.register(this, username.getText().toString(), password.getText().toString());
            Toast.makeText(this, "Signing in .. Please Wait", Toast.LENGTH_LONG).show();

        } catch (Exception e) {
            Toast.makeText(this, " signed up Exception", Toast.LENGTH_SHORT).show();
        }
