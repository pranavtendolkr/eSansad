 ...
 */
public class MyCardsView extends Fragment {

    public static MyCardsView newInstance(String type) {
        MyCardsView myFragment = new MyCardsView();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_myview_list, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(getArguments().getString("type").equals(Constants.IS_PROJECT)){
            proposalList = APIHelper.getProposalsBySelf(this.getActivity(), "goa", "North Goa");
        }else{
            proposalList = APIHelper.getProposalsBySelf(this.getActivity(), "goa", "North Goa");
        }
        ...
        CardListView listView = (CardListView) getActivity().findViewById(R.id.myList1);
        if (listView!=null){
